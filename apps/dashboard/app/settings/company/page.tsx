...
export default function CompanySettingsPage() {
  return <AppShell accountMode="dashboard" appName="Organization Settings" notificationCount={3} nav={[{ label: "Dashboard", href: "/" }, { label: "Company", href: "/settings/company" }, { label: "Trust", href: "/trust" }, { label: "Invoices", href: "/invoices" }]}> 
