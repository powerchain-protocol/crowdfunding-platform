...
const requiredPackages = ["ui","config","types","campaign","payment-intent","treasury","ledger","reconciliation","events","providers","sdk","api-core","common","evidence","auth","identity","agreements","audit","escrow","notifications","moderation","deals","deal-room","i18n","proofs","activity","security-data","zk","data","hooks","storage","store","realtime","funding"];
const missing=[];
